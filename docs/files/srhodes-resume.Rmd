...
- **R + R-Studio**: used for over 10 years; developed the pmcalibration and pminternal packages
- **Python**: regularly used packages: numpy, pandas, scipy, psychopy, sklearn
- **Other Programming Languages**: SLURM (for high performance computing); SQL (for databases); Stan (for Bayesian Modeling)
...
- **Communication**: both written and spoken to both technical and non-technical audiences
...
exp = tribble(
  ...
  c("Primary statistician on \\href{https://www.pcori.org/research-results/2024/bulking-versus-sling-treating-stress-urinary-incontinence-time-vaginal-prolapse-repair}{multi-center randomized trial funded by PCORI.}",
    ...
    "Develop and evaluate clinical prediction models. Wrote two R packages that implement best-practices for internal validation (pminternal) and assessing calibration (pmcalibration) of prediction models.",
