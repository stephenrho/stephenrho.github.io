...
- **Other Programming Languages**: SLURM (for high performance computing); SQL (for databases); JAGS, Stan (for Bayesian modeling); python (misc)
- **Clinical Research**: experimental design, clinical trial design; analysis of large healthcare databases; causal inference with observational data; Epic Cosmos superuser
- **Communication**: both written and spoken to both expert and lay audiences; regularly give seminars/workshops on statistical methods
...
exp = tribble(
  ...
  c("Designed and conducted experiments on age-related changes to short- and long-term memory.",
